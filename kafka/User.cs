...
namespace kafka
{
	...
	{
		public static Schema _SCHEMA = Schema.Parse("{\"type\":\"record\",\"name\":\"User\",\"namespace\":\"kafka\",\"fields\":[{\"name\":\"name\",\"type" +
				"\":\"string\"},{\"name\":\"favorite_number\",\"type\":[\"int\",\"null\"]},{\"name\":\"favorite_c" +
				"olor\",\"type\":[\"string\",\"null\"]}]}");
